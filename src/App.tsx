      ...
      <form className='flex flex-col gap-4 items-stretch w-full max-w-[400px] mt-10'>
        ...
        <label htmlFor="password" className='flex flex-col gap-3' >
          ...
          <TextInput.Root>
            ...
            <TextInput.Input id='password' type="password" placeholder='Digite sua senha'></TextInput.Input>
          </TextInput.Root>
        </label>

        <label htmlFor='remember' className='flex items-center gap-2'>
          <Checkbox id='remember' />
          <Text size='sm' className='text-gray-200 select-none'>Lembrar de mim por 30 dias</Text>
        </label>
